...
-- Run this after the main schema to enable proper multi-tenancy
...
-- Enhanced RLS policies that work with both user_id and client_id
...
-- Updated policies that work with both authentication methods
...
GRANT EXECUTE ON FUNCTION set_user_context(TEXT, UUID) TO authenticated;
