      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {students.map((student, index) => (
            <div key={student.id}>
              <Card className="border border-[#1a1a1a] bg-[#0f0f0f] shadow-lg hover:shadow-xl transition-all">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-lg text-[#F8FAFC]">{student.name || 'Unknown'}</CardTitle>
        ...
        {students.length === 0 && (
          <Card className="border border-[#1a1a1a] bg-[#0f0f0f] shadow-lg">
            <CardContent className="py-16 text-center">
              <Users className="h-16 w-16 mx-auto mb-4 text-[#1a1a1a]" />
