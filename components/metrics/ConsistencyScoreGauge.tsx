...
export default function ConsistencyScoreGauge({ data }: ConsistencyScoreGaugeProps) {
  ...
  return (
    <Card className="rounded-2xl border border-[#1a1a1a] bg-[#0f0f0f] overflow-hidden transition-all hover:border-[#8B5CF6]/30">
      <CardContent className="p-6">
          ...
          <div className="relative w-32 h-32">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#F8FAFC]">{averageScore.toFixed(0)}</div>
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-sm font-semibold text-[#F8FAFC] flex-shrink-0">{distribution.high}</span>
          </div>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-sm font-semibold text-[#F8FAFC] flex-shrink-0">{distribution.medium}</span>
          </div>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-sm font-semibold text-[#F8FAFC] flex-shrink-0">{distribution.low}</span>
          </div>
        </div>
        ...
        <div className="mt-4 pt-4 border-t border-[#1a1a1a]">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className={`text-sm font-semibold flex-shrink-0 ${trend.startsWith('+') ? 'text-emerald-400' : 'text-red-400'}`}>
              {trend}
            </span>
          </div>
        </div>
